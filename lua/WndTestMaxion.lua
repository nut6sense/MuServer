...
function DoStart()
	...
	for i = 1, 10 do
		...
		myButton:setSize(20,20)  -- 20px x 20px button
		...
		myButton:subscribeEvent("Clicked", function()
			print("Button " .. tostring(i) .. " clicked!")
			TestButton:setText("Dragon Debug Button: Button number" .. tostring(i) .. " is clicked!")
			winMgr:getWindow("DebugButton"):setText("Dragon Debug Button: Button number" .. tostring(i) .. " is clicked!")
