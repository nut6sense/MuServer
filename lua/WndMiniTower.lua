...
-- 미니타워용
local CASTLE_POSX = 282
local CASTLE_POSY = 46



-- 채팅창  초기  설정
function SetChatInitMiniTowerGame()
...
function WndGame_RenderMiniTowerHP( deltaTime, red, blue, redUISize, blueUISize, bRedEffect, bBlueEffect )
	...
	drawer:drawTexture("UIData/match001.tga", CASTLE_POSX, CASTLE_POSY, 460, 44, 0, 71, WIDETYPE_5)
	
	local _redEffectGauge = redEffectGauge % 60
	if _redEffectGauge < 30 then
		drawer:drawTexture("UIData/match001.tga", CASTLE_POSX+9, CASTLE_POSY+7, redUISize, 27, 0, 115, WIDETYPE_5)
	else
		drawer:drawTexture("UIData/match001.tga", CASTLE_POSX+9, CASTLE_POSY+7, redUISize, 27, 0, 169, WIDETYPE_5)
	end
	
	local _blueEffectGauge = blueEffectGauge % 60
	if _blueEffectGauge < 30 then
		drawer:drawTexture("UIData/match001.tga", CASTLE_POSX+9+redUISize, CASTLE_POSY+7, blueUISize, 27, redUISize, 142, WIDETYPE_5)
	else
		drawer:drawTexture("UIData/match001.tga", CASTLE_POSX+9+redUISize, CASTLE_POSY+7, blueUISize, 27, redUISize, 169, WIDETYPE_5)
	end
	
	DrawEachNumberWide2("UIData/match001.tga", red, 1, CASTLE_POSX+13, CASTLE_POSY-28, 0, 196, 38, 42, 29, 38, WIDETYPE_5)
	
	if blue >= 100 then
		DrawEachNumberWide2("UIData/match001.tga", blue, 1, CASTLE_POSX+335, CASTLE_POSY-28, 0, 238, 38, 42, 29, 38, WIDETYPE_5)
	elseif blue < 10 then
		DrawEachNumberWide2("UIData/match001.tga", blue, 1, CASTLE_POSX+393, CASTLE_POSY-28, 0, 238, 38, 42, 29, 38, WIDETYPE_5)
	else
		DrawEachNumberWide2("UIData/match001.tga", blue, 1, CASTLE_POSX+364, CASTLE_POSY-28, 0, 238, 38, 42, 29, 38, WIDETYPE_5)
	end
	
	if red >= 100 then
		drawer:drawTexture("UIData/match001.tga", CASTLE_POSX+100, CASTLE_POSY-28, 38, 42, 380, 197, WIDETYPE_5)
	elseif red < 10 then
		drawer:drawTexture("UIData/match001.tga", CASTLE_POSX+42, CASTLE_POSY-28, 38, 42, 380, 197, WIDETYPE_5)
	else
		drawer:drawTexture("UIData/match001.tga", CASTLE_POSX+71, CASTLE_POSY-28, 38, 42, 380, 197, WIDETYPE_5)
	end
	
	drawer:drawTexture("UIData/match001.tga", CASTLE_POSX+422, CASTLE_POSY-28, 38, 42, 380, 239, WIDETYPE_5)
end
...
local WATCHING_WHO = GetSStringInfo(LAN_CLUBWAR_PLAY_OBSERVER)	-- %s 관전중
...
local MINIMAP_POSX = 412 -- 370
local MINIMAP_POSY = 625 -- 650
local MINIMAP_SIZEX = 187 -- 262
local MINIMAP_SIZEY = 118 -- 119
...
--	drawer:drawTextureA("UIData/bumbmode.tga", MINIMAP_POSX, MINIMAP_POSY, 262, 119, 762, 0, 255, WIDETYPE_7)
	drawer:drawTextureA("UIData/fightClub_006.tga", MINIMAP_POSX, MINIMAP_POSY, 187, 118, 838, 380, 200, WIDETYPE_7)
end

function WndGame_RenderCharacterPosToMap(myTeam, x, y, angle, hp)
	local posX =  x+94
	local posY = -y+59
	local texX = 497
	local texY = 0
...
function WndGame_RenderMyCharacterPosToMap(myTeam, x, y, angle, hp)
