...
function SettingDecoUpgradeImg(FileName, GradeNumber)
	...
	elseif GRADENUMBER == GRADE_LEGEND then
		winMgr:getWindow("DecoUpgradeCharge"):clearTextExtends()
		...
		--else
			winMgr:getWindow("DecoUpgradeCharge"):setPosition(166, 251)
			winMgr:getWindow("DecoUpgradeCharge"):setText("3,000,000")
		--end
		
		winMgr:getWindow("DecoUpgradeGradeImage2"):setTexture("Enabled", "UIData/Deco.tga", 339, 70)
		winMgr:getWindow("DecoUpgradeGradeImage2"):setTexture("Disabled", "UIData/Deco.tga", 339, 70)
		
		winMgr:getWindow("DecoUpgradeGradeImage1"):setTexture("Enabled", "UIData/Deco.tga", 339, 87)
		winMgr:getWindow("DecoUpgradeGradeImage1"):setTexture("Disabled", "UIData/Deco.tga", 339, 87)
	end
end
