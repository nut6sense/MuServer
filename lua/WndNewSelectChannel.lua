function WndSelectChannel_WndSelectChannel2()
...
local IS_TESTSERVER = IsTestVersion()
Quitindex = 1
...
mywindow:setTexture("Normal",	"UIData/channel_004.tga", 686, 639)
mywindow:setTexture("Hover",	"UIData/channel_004.tga", 686, 693)
mywindow:setTexture("Pushed",	"UIData/channel_004.tga", 686, 747)
mywindow:setTexture("PushedOff","UIData/channel_004.tga", 686, 747)
...
-----------------------------------------------------------------------------
-- 2차 비밀번호 관련★ ("태국" 전용 컨텐츠)
-----------------------------------------------------------------------------
if IsThaiLanguage() or IsEngLanguage() or IsGSPLanguage() then -- 태국만 생성한다.----0421KSG
	...
	function SetModeCreatePassword()
		...
		SetSecondPasswordFlag(1)
		SetCurrentSelectIndex(4)	-- 채널 선택 막기
		SetModeButtonEnable(false , false)
	end
...
function WndSelectChannel_RenderBackImage()
	...
	--drawer:drawTexture("UIData/channel_002.tga", 0, 0, 1024, 69, 0, 936, WIDETYPE_5)	-- (위쪽)투명한 배경
	--drawer:drawTexture("UIData/channel_002.tga", 355, 0, 314, 45, 493, 891, WIDETYPE_5)	-- (위쪽)Server & Channel (텍스트)
	
	-- 한국이 아닐경우만 서버리스트 보이게 한다.
	if CheckfacilityData(FACILITYCODE_ZONE3) == 1 then
		drawer:drawTexture("UIData/channel_004.tga", 30, 90, 254, 604, 0, 0, WIDETYPE_6) -- Server List
	end
end
...
if CheckfacilityData(FACILITYCODE_ZONE3) == 1 then
	...
	for i=0, #tServerList_posY do
		...
		mywindow:setTexture("Normal",		"UIData/channel_004.tga", 0, 604)
		mywindow:setTexture("Hover",		"UIData/channel_004.tga", 0, 646)
		mywindow:setTexture("Pushed",		"UIData/channel_004.tga", 0, 688)
		mywindow:setTexture("PushedOff",	"UIData/channel_004.tga", 0, 604)
		mywindow:setTexture("SelectedNormal",	"UIData/channel_004.tga", 0, 688)
		mywindow:setTexture("SelectedHover",	"UIData/channel_004.tga", 0, 688)
		mywindow:setTexture("SelectedPushed",	"UIData/channel_004.tga", 0, 688)
		mywindow:setTexture("SelectedPushedOff","UIData/channel_004.tga", 0, 688)
		mywindow:setTexture("Enabled",			"UIData/channel_004.tga", 0, 604)
		mywindow:setTexture("Disabled",			"UIData/channel_004.tga", 0, 730)
		mywindow:setProperty("GroupID", 1995)	
		mywindow:setWideType(6);
		mywindow:setPosition(40, tServerList_posY[i])
		mywindow:setSize(236, 42)
		mywindow:setAlwaysOnTop(true)
		mywindow:setZOrderingEnabled(false)
...
channelListbackwindow:setTexture("Enabled",	 "UIData/channel_004.tga", 0, 0)
channelListbackwindow:setTexture("Disabled", "UIData/channel_004.tga", 0, 0)
...
local y = 1200;
channelListbackwindow = winMgr:createWindow("TaharezLook/StaticImage", "sj_SelectChannel_ChannelList_backImage")
--channelListbackwindow:setTexture("Enabled",	"UIData/invisible.tga", 0 , 0)
--channelListbackwindow:setTexture("Disabled", "UIData/invisible.tga", 0 , 0)
channelListbackwindow:setTexture("Enabled",	 "UIData/frame/frame_001.tga", 0 , 0)
channelListbackwindow:setTexture("Disabled", "UIData/frame/frame_001.tga", 0 , 0)
channelListbackwindow:setframeWindow(true)
channelListbackwindow:setWideType(6)

if CheckfacilityData(FACILITYCODE_ZONE3) == 1 then
	channelListbackwindow:setPosition(x, y)
	channelListbackwindow:addController("channelController", "BottonMenuUpEvent", "y", "Sine_EaseInOut", 1200 , 223, 3, true, false, 10)
	channelListbackwindow:addController("channelController", "BottonMenuDownEvent", "y", "Sine_EaseInOut", 223, 1200, 3, true, false, 10)
else
	channelListbackwindow:setPosition(270, 1200)
...
channelListbackwindow:setSize(632, 434)
channelListbackwindow:setAlwaysOnTop(true)
channelListbackwindow:setVisible(false)
channelListbackwindow:setZOrderingEnabled(false)
channelListbackwindow:subscribeEvent("EndRender", "RenderChannelBackImage")

root:addChildWindow(channelListbackwindow)
--CreateNewFrameSetWindow(channelListbackwindow:getName(), 632, 434, 0)


-- zone6 타이틀
local MAX_ZONE = 2;

local tZoneIndex = { ['err']=0, [0] = 4 , 1 }; -- 6구역 , 3구역
local tTexPosY = { ['err']=0, [0] = 801, 846 };
for i = 0 , MAX_ZONE-1 do 
	mywindow = winMgr:createWindow("TaharezLook/StaticImage", "SelectChannel_TitleTextImg_" .. tZoneIndex[i])
	mywindow:setTexture("Enabled",	"UIData/channel_004.tga", 493, tTexPosY[i])
	mywindow:setTexture("Disabled", "UIData/channel_004.tga", 493, tTexPosY[i])
	mywindow:setProperty("FrameEnabled", "False")
	mywindow:setProperty("BackgroundEnabled", "False")
	mywindow:setPosition((632/2)-(314/2), 5)
	mywindow:setSize(314, 45)
	mywindow:setEnabled(false)
	mywindow:setVisible(true)
	mywindow:setZOrderingEnabled(false)	
	channelListbackwindow:addChildWindow(mywindow)
end
function ConnectChannelText(zoneIndex)
	
	for i = 0 , MAX_ZONE-1 do
		winMgr:getWindow("SelectChannel_TitleTextImg_" .. tZoneIndex[i]):setVisible(false)
	end
	
	DebugStr("zoneIndex : " .. zoneIndex)
	winMgr:getWindow("SelectChannel_TitleTextImg_" .. zoneIndex):setVisible(true);	
end

-- Server & Channel Image
mywindow = winMgr:createWindow("TaharezLook/StaticImage", "SelectChannel_MainTitleTexImg")
mywindow:setTexture("Enabled",	"UIData/channel_004.tga", 493, 846+45)
mywindow:setTexture("Disabled", "UIData/channel_004.tga", 493, 846+45)
mywindow:setProperty("FrameEnabled", "False")
mywindow:setProperty("BackgroundEnabled", "False")
mywindow:setWideType(6)
mywindow:setPosition(380, 0)
mywindow:setSize(314, 45)
mywindow:setEnabled(false)
mywindow:setVisible(true)
mywindow:setZOrderingEnabled(false)	
...
function RenderChannelBackImage(args)
	...
	local posX = position.x.offset + parentPos.x.offset + 290
	local posY = position.y.offset + parentPos.y.offset + 362
...
function ShowChannelList(zoneIndex)
	...
	--else
		...
		if CheckfacilityData(FACILITYCODE_ZONE3) == 1 then
			DebugStr("ShowChannelList() 호출")
			winMgr:getWindow('sj_SelectChannel_ChannelList_backImage'):addController("channelController", "BottonMenuUpEvent", "y", "Sine_EaseInOut", 800 , 160, 3, true, false, 10)
		else
...
local tChannelPosX = {["err"]=0, [0]=	8, 130, 252, 376, 503,
										8, 130, 252, 376, 503,
										8, 130, 252, 376, 503,
										8, 130, 252, 376, 503,
										8, 130, 252, 376, 503,
...
local tChannelPosY = {["err"]=0, [0]=	62, 62, 62, 62, 62,
										112, 112, 112, 112, 112, 
										162, 162, 162, 162, 162, 
										212, 212, 212, 212, 212, 
										262, 262, 262, 262, 262,
...
for i=0, MAX_VILLAGE_CHANNEL-1 do
	...
	channelwindow:setTexture("Normal",				"UIData/channel_004.tga", 0, 772)
	channelwindow:setTexture("Hover",				"UIData/channel_004.tga", 0, 814)
	channelwindow:setTexture("Pushed",				"UIData/channel_004.tga", 2, 860)
	channelwindow:setTexture("PushedOff",			"UIData/channel_004.tga", 2, 860)
	channelwindow:setTexture("SelectedNormal",		"UIData/channel_004.tga", 2, 860)
	channelwindow:setTexture("SelectedHover",		"UIData/channel_004.tga", 2, 860)
	channelwindow:setTexture("SelectedPushed",		"UIData/channel_004.tga", 2, 860)
	channelwindow:setTexture("SelectedPushedOff",	"UIData/channel_004.tga", 2, 860)
	channelwindow:setTexture("Enabled",				"UIData/channel_004.tga", 2, 860)
	channelwindow:setTexture("Disabled",			"UIData/channel_004.tga", 2, 860)
	channelwindow:setPosition(tChannelPosX[i], tChannelPosY[i])
	channelwindow:setSize(119, 42)
	channelwindow:setProperty("GroupID", 2102)
	channelwindow:setUserString("channelNumber", tostring(i))
	channelwindow:setUserString("NumberCount", i)
	...
	--if IS_TESTSERVER == 1 then
		mywindow:setPosition(8, 8)
	--else
	--	mywindow:setPosition(80, 8)
	--end
	...
	mywindow:setTexture("Enabled",	"UIData/channel_004.tga", 531, 725)
	mywindow:setTexture("Disabled", "UIData/channel_004.tga", 531, 725)
	mywindow:setProperty("FrameEnabled", "False")
	mywindow:setProperty("BackgroundEnabled", "False")
	...
	mywindow:setTexture("Enabled",	"UIData/channel_004.tga", 531, 735)
	mywindow:setTexture("Disabled", "UIData/channel_004.tga", 531, 735)
	mywindow:setProperty("FrameEnabled", "False")
	mywindow:setProperty("BackgroundEnabled", "False")
	mywindow:setPosition(5, 25)
	--mywindow:setSize(134, 10)
...
function RenderChannelInfos(args)
	...
	local NumberCount				= window:getUserString("NumberCount")
	...
	local Ten = ( squareIndex +1) / 10
	local one = ( squareIndex +1) % 10
	
	--if IS_TESTSERVER ~= 1 then
	--	if zoneIndex >= 0 then
	--		if zoneIndex == 3 then -- 차이나
	--			if CheckfacilityData(FACILITYCODE_ZONE3) == 0 then
	--				--drawer:drawTexture("UIData/channel_004.tga", posX+7, posY+3, 61, 19, 592, 766)
	--				--local _left = DrawEachNumber("UIData/channel_004.tga", Ten, 1, posX+55, posY, 493, 703, 14, 19, 14)
	--				--local _left2 = DrawEachNumber("UIData/channel_004.tga", one, 1, posX+65, posY, 493, 703, 14, 19, 14)
	--			else
	--				drawer:drawTexture("UIData/channel_004.tga", posX+7, posY+3, 61, 19, 592, 766)
	--				local _left = DrawEachNumber("UIData/channel_004.tga", Ten, 1, posX+55, posY, 493, 703, 14, 19, 14)
	--				local _left2 = DrawEachNumber("UIData/channel_004.tga", one, 1, posX+65, posY, 493, 703, 14, 19, 14)
	--			end
	--		
	--		elseif zoneIndex == 6 then -- 광장
	--				drawer:drawTexture("UIData/channel_004.tga", posX+7, posY+3, 61, 19, 531, 766)
	--				local _left = DrawEachNumber("UIData/channel_004.tga", Ten, 1, posX+55, posY+4, 493,  688, 14, 19, 14)
	--				local _left2 = DrawEachNumber("UIData/channel_004.tga", one, 1, posX+65, posY+4, 493,  688, 14, 19, 14)
	--		end
	--	end
	--end		
end
...
function WndSelectChannel_VillageExistChannel(i, userPercent, name, zoneNumber)
	--DebugStr("광장 채널이 존재할 경우 업데이트 : " .. i)
	winMgr:getWindow(i.."sj_SelectChannel_channelRadioButton"):setVisible(true)
	
	--if IS_TESTSERVER == 1 then
		DebugStr("광장 채널 : " .. name) -- rkawk
		winMgr:getWindow(i.."sj_SelectChannel_channelNameText"):clearTextExtends()
		winMgr:getWindow(i.."sj_SelectChannel_channelNameText"):setVisible(true)	
	...
	winMgr:getWindow(i.."sj_SelectChannel_confusionIcon"):setTexture("Enabled",		"UIData/channel_004.tga", 531, tex_y + 25)
	winMgr:getWindow(i.."sj_SelectChannel_confusionIcon"):setTexture("Disabled",	"UIData/channel_004.tga", 531, tex_y + 25)
...
tZonePageButtonPosX  = { ["err"]=0, 254, 352 }
...
for i=1, 2 do
	...
	mywindow:setTexture("Normal",		"UIData/channel_004.tga", tZonePageButtonTexX[i], 725)
	mywindow:setTexture("Hover",		"UIData/channel_004.tga", tZonePageButtonTexX[i], 750)
	mywindow:setTexture("Pushed",		"UIData/channel_004.tga", tZonePageButtonTexX[i], 775)
	mywindow:setTexture("PushedOff",	"UIData/channel_004.tga", tZonePageButtonTexX[i], 725)
	mywindow:setPosition(tZonePageButtonPosX[i], 357)
...
mywindow:setTexture("Normal",	"UIData/channel_004.tga", 807, 801)
mywindow:setTexture("Hover",	"UIData/channel_004.tga", 807, 837)
mywindow:setTexture("Pushed",	"UIData/channel_004.tga", 807, 873)
mywindow:setTexture("PushedOff","UIData/channel_004.tga", 807, 873)
mywindow:setTexture("Enabled",	"UIData/channel_004.tga", 807, 873)
mywindow:setTexture("Disabled", "UIData/channel_004.tga", 807, 873)

if CheckfacilityData(FACILITYCODE_ZONE3) == 1 then
	mywindow:setPosition(194, 382)
else
	mywindow:setPosition(190, 282)
end

mywindow:setSize(111, 36)
mywindow:setZOrderingEnabled(false)
...
if CheckfacilityData(FACILITYCODE_ZONE3) == 1 then
	...
	mywindow:setTexture("Normal",	"UIData/channel_004.tga", 807, 909)
	mywindow:setTexture("Hover",	"UIData/channel_004.tga", 807, 945)
	mywindow:setTexture("Pushed",	"UIData/channel_004.tga", 807, 981)
	mywindow:setTexture("PushedOff","UIData/channel_004.tga", 807, 981)
	mywindow:setPosition(314, 382)
	mywindow:setSize(111, 36)
	mywindow:setZOrderingEnabled(false)
...
RegistEscEventInfo("SelectChannel_messageWindow", "PopupExit_CANCEL")
