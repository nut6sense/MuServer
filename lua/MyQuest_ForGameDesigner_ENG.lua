...
local MAX_QUESTNUMBER = 58				-- 퀘스트의 갯수를 세팅한다.
...
tQuestTargetPos[53][QUEST_TYPE_OCCUR]		= {['err']=0, -2819, 2146, 0}	-- 엠마맘슨
tQuestTargetPos[53][QUEST_TYPE_OCCUR_ACCEPT]	= {['err']=0, -3634, 1960, 0}	-- 사냥터
tQuestTargetPos[53][QUEST_TYPE_COMPLETE]	= {['err']=0, -2819, 2146, 0}	-- 엠마맘슨

tQuestTargetPos[54][QUEST_TYPE_OCCUR]		= {['err']=0, 1195, 3357, 0}	-- 스피커맨
tQuestTargetPos[54][QUEST_TYPE_OCCUR_ACCEPT]	= {['err']=0, 2206, 2753, 0}	-- 대전 포탈
tQuestTargetPos[54][QUEST_TYPE_COMPLETE]	= {['err']=0, 1195, 3357, 0}	-- 스피커맨

tQuestTargetPos[55][QUEST_TYPE_OCCUR]		= {['err']=0, 188, 4349, 0}	-- 안젤라맘슨
tQuestTargetPos[55][QUEST_TYPE_COMPLETE]	= {['err']=0, 188, 4349, 0}	-- 안젤라맘슨

tQuestTargetPos[56][QUEST_TYPE_OCCUR]		= {['err']=0, -2819, 2146, 0}	-- 엠마맘슨
tQuestTargetPos[56][QUEST_TYPE_OCCUR_ACCEPT]	= {['err']=0, -3634, 1960, 0}	-- 사냥터
tQuestTargetPos[56][QUEST_TYPE_COMPLETE]	= {['err']=0, -2819, 2146, 0}	-- 엠마맘슨

tQuestTargetPos[57][QUEST_TYPE_OCCUR]		= {['err']=0, 1195, 3357, 0}	-- 스피커맨
tQuestTargetPos[57][QUEST_TYPE_OCCUR_ACCEPT]	= {['err']=0, 2206, 2753, 0}	-- 대전 포탈
tQuestTargetPos[57][QUEST_TYPE_COMPLETE]	= {['err']=0, 1195, 3357, 0}	-- 스피커맨

tQuestTargetPos[58][QUEST_TYPE_OCCUR]		= {['err']=0, 188, 4349, 0}	-- 안젤라맘슨
tQuestTargetPos[58][QUEST_TYPE_COMPLETE]	= {['err']=0, 188, 4349, 0}	-- 안젤라맘슨
...
tQuestCondition[18] = {['err']=0, [0]= 2875	, 0	, 0	, 0	, 0	}
tQuestCondition[19] = {['err']=0, [0]= 2882	, 0	, 0	, 0	, 0	}
...
tQuestCondition[48] = {['err']=0, [0]= 4368	, 0	, 0	, 0	, 0	}
