...
function WndLobby_RenderBackImage(currentBattleChannelName)
	...
	if GetCurrentChannelBattleMode() == BATTLETYPE_FULL_SKILL then
		...
		drawer:drawTexture("UIData/mainBG_Button001.tga", 50, 20, 281, 46, 0, 256, WIDETYPE_6)	-- 프리존
		
	else
		drawer:drawTexture("UIData/RoomWideBack.dds", 0, 0, g_LOBBY_WIN_SIZEX, g_LOBBY_WIN_SIZEY, (1920-g_LOBBY_WIN_SIZEX)/2 , (1200-g_LOBBY_WIN_SIZEY)/2)
		drawer:drawTexture("UIData/mainBG_Button001.tga", 0, 0, 1024, 71, 0, 0, WIDETYPE_6)			-- 윗쪽 바
		if GetCurrentChannelBattleMode() == 1 then
			drawer:drawTexture("UIData/mainBG_Button001.tga", 50, 20, 281, 46, 0, 486, WIDETYPE_6)	-- 익스퍼트
		elseif GetCurrentChannelBattleMode() == 5 then
			drawer:drawTexture("UIData/mainBG_Button001.tga", 50, 20, 281, 46, 0, 532, WIDETYPE_6)	-- 지엠채널
		else
			drawer:drawTexture("UIData/mainBG_Button001.tga", 50, 20, 281, 46, 0, 118, WIDETYPE_6)	-- 대전로비 글자
		end
	end
	
	drawer:drawTexture("UIData/LobbyImage_new.tga", 13, 123, 662, 389, 2, 3, WIDETYPE_6)		-- 방 정보
	
	if g_BattleMode ~= BATTLETYPE_GM_CHANNEL then
...
if g_BattleMode == BATTLETYPE_GM_CHANNEL then
	winMgr:getWindow("sj_lobby_GoBattleRoomBtn"):setVisible(false)
	winMgr:getWindow("sj_lobby_GoBattleRoomBtn"):setVisible(false)
	winMgr:getWindow("sj_lobby_GoBattleRoomBtn"):setVisible(false)
end
...
if g_BattleMode == BATTLETYPE_GM_CHANNEL then
	winMgr:getWindow("sj_lobby_enterRoomEditBox"):setVisible(false)
	winMgr:getWindow("sj_lobby_enterRoomEditBox"):setVisible(false)
	winMgr:getWindow("sj_lobby_enterRoomEditBox"):setVisible(false)
end
...
PLAYTYPE_CLASS = 2
PLAYTYPE_BOMB = 3
PLAYTYPE_MINITOWER_NOITEM = 4
PLAYTYPE_MINITOWER_ITEM = 5
...
function WndLobby_ExistBattleRoom(index, roomNumber, roomName, bTeam, bItem, 
	...
	winMgr:getWindow(index .. "sj_lobby_roomList_roomIndex"):setPosition(32-roomNum/2, 11)
	...
	if roomState == 0 then
		...
		if gameMode == 0 then
			...
			elseif bItem == PLAYTYPE_MINITOWER_NOITEM or bItem == PLAYTYPE_MINITOWER_ITEM then
				winMgr:getWindow(index .. "sj_lobby_roomList_isMRBattleRoom"):setTexture("Disabled", "UIData/match003.tga", 570, 610)
			else
	...
	-- 게임중일때
		...
		if gameMode == 0 then
			...
			elseif bItem == PLAYTYPE_MINITOWER_NOITEM or bItem == PLAYTYPE_MINITOWER_ITEM then
				winMgr:getWindow(index .. "sj_lobby_roomList_isMRBattleRoom"):setTexture("Disabled", "UIData/match003.tga", 570, 633)
			else
...
if g_BattleMode == BATTLETYPE_GM_CHANNEL then
	winMgr:getWindow("sj_lobby_fastMatch_random"):setVisible(false)
	winMgr:getWindow("sj_lobby_fastMatch_adjust"):setVisible(false)
	winMgr:getWindow("sj_lobby_fastMatch_adjustBox"):setVisible(false)
end
...
local tMatchThaiName  = {['err'] = 0, [0]= "Lobby_CheckBox_DeathMatch", "Lobby_CheckBox_MonsterRacing", "Lobby_CheckBox_DualMatch",
							"Lobby_CheckBox_CoinMatch", "Lobby_CheckBox_BombMatch" }
...
local tMatchThaiEvent = {['err'] = 0, [0]= "DeathMatchCheck", "MonsterRacingCheck", "DualMatchCheck", "CoiMatchCheck", "BombMatchCheck" }
...
local tLanguageMatchName  = {['err'] = 0, [0]= tMatchEngName,  tMatchKorName,  tMatchThaiName,	tMatchMasName, tMatchIdnName}
local tLanguageMatchEvent = {['err'] = 0, [0]= tMatchEngEvent, tMatchKorEvent, tMatchThaiEvent,	tMatchMasEvent, tMatchIdnEvent}
...
-- New
local tMatchName = {['err'] = 0, [0]= "Lobby_CheckBox_DeathMatch", "Lobby_CheckBox_MonsterRacing", "Lobby_CheckBox_DualMatch",
												"Lobby_CheckBox_CoinMatch", "Lobby_CheckBox_BombMatch", "Lobby_CheckBox_MiniTowerMatch" }
												
local tMatchEvent = {['err'] = 0, [0]= "DeathMatchCheck", "MonsterRacingCheck", "DualMatchCheck", "CoiMatchCheck", "BombMatchCheck", "MiniTowerMatchCheck" }
												
local tMatchPosX  = {['err'] = 0, [0]= 112, 209, 306, 112, 209, 306}
local tMatchPosY  = {['err'] = 0, [0]= 39,  39, 39, 77, 77, 77}
...
if CheckfacilityData(FACILITYCODE_DEATHMATCH) == 1 then
	...
	mywindow = winMgr:createWindow("TaharezLook/Checkbox", tMatchName[0])
	mywindow:setTexture("Normal", "UIData/invisible.tga", 515, 284)
	mywindow:setTexture("Hover", "UIData/invisible.tga", 515, 284)
	mywindow:setTexture("Pushed", "UIData/LobbyImage_new002.tga", 515, 284)
	mywindow:setTexture("PushedOff", "UIData/invisible.tga", 515, 284)
	...
	mywindow:setTexture("SelectedPushed", "UIData/LobbyImage_new002.tga", 515, 284)
	mywindow:setTexture("SelectedPushedOff", "UIData/invisible.tga", 515, 284)
	mywindow:setPosition(tMatchPosX[0], tMatchPosY[0])
	mywindow:setSize(27, 27)
	mywindow:setAlwaysOnTop(true)
	mywindow:setZOrderingEnabled(false)
	mywindow:setProperty("Selected", "false")
	mywindow:subscribeEvent("CheckStateChanged", tMatchEvent[0])
	quickmatchBackwindow:addChildWindow(mywindow)
end
...
if CheckfacilityData(FACILITYCODE_SURVIVAL) == 1 then
	...
	mywindow = winMgr:createWindow("TaharezLook/Checkbox", tMatchName[1])
	mywindow:setTexture("Normal", "UIData/invisible.tga", 515, 284)
	mywindow:setTexture("Hover", "UIData/invisible.tga", 515, 284)
	mywindow:setTexture("Pushed", "UIData/LobbyImage_new002.tga", 515, 284)
	mywindow:setTexture("PushedOff", "UIData/invisible.tga", 515, 284)
	...
	mywindow:setTexture("SelectedPushed", "UIData/LobbyImage_new002.tga", 515, 284)
	mywindow:setTexture("SelectedPushedOff", "UIData/invisible.tga", 515, 284)
	mywindow:setPosition(tMatchPosX[1], tMatchPosY[1])
	mywindow:setSize(27, 27)
	mywindow:setAlwaysOnTop(true)
	mywindow:setZOrderingEnabled(false)
	mywindow:setProperty("Selected", "false")
	mywindow:subscribeEvent("CheckStateChanged", tMatchEvent[1])
	quickmatchBackwindow:addChildWindow(mywindow)
end
...
if CheckfacilityData(FACILITYCODE_DUELBATTLE) == 1 then
	...
	mywindow = winMgr:createWindow("TaharezLook/Checkbox", tMatchName[2])
	mywindow:setTexture("Normal", "UIData/invisible.tga", 515, 284)
	mywindow:setTexture("Hover", "UIData/invisible.tga", 515, 284)
	mywindow:setTexture("Pushed", "UIData/LobbyImage_new002.tga", 515, 284)
	mywindow:setTexture("PushedOff", "UIData/invisible.tga", 515, 284)
	...
	mywindow:setTexture("SelectedPushed", "UIData/LobbyImage_new002.tga", 515, 284)
	mywindow:setTexture("SelectedPushedOff", "UIData/invisible.tga", 515, 284)
	mywindow:setPosition(tMatchPosX[2], tMatchPosY[2])
	mywindow:setSize(27, 27)
	mywindow:setAlwaysOnTop(true)
	mywindow:setZOrderingEnabled(false)
	mywindow:setProperty("Selected", "false")
	mywindow:subscribeEvent("CheckStateChanged", tMatchEvent[2])
	quickmatchBackwindow:addChildWindow(mywindow)
end
...
if CheckfacilityData(FACILITYCODE_COINBATTLE) == 1 then
	...
	mywindow = winMgr:createWindow("TaharezLook/Checkbox", tMatchName[3])
	mywindow:setTexture("Normal", "UIData/invisible.tga", 515, 284)
	mywindow:setTexture("Hover", "UIData/invisible.tga", 515, 284)
	mywindow:setTexture("Pushed", "UIData/LobbyImage_new002.tga", 515, 284)
	mywindow:setTexture("PushedOff", "UIData/invisible.tga", 515, 284)
	...
	mywindow:setTexture("SelectedPushed", "UIData/LobbyImage_new002.tga", 515, 284)
	mywindow:setTexture("SelectedPushedOff", "UIData/invisible.tga", 515, 284)
	mywindow:setPosition(tMatchPosX[3], tMatchPosY[3])
	mywindow:setSize(27, 27)
	mywindow:setAlwaysOnTop(true)
	mywindow:setZOrderingEnabled(false)
	mywindow:setProperty("Selected", "false")
	mywindow:subscribeEvent("CheckStateChanged", tMatchEvent[3])
	quickmatchBackwindow:addChildWindow(mywindow)
end
...
if CheckfacilityData(FACILITYCODE_BOOMBATTLE) == 1 then
	...
	mywindow = winMgr:createWindow("TaharezLook/Checkbox", tMatchName[4])
	mywindow:setTexture("Normal", "UIData/invisible.tga", 515, 284)
	mywindow:setTexture("Hover", "UIData/invisible.tga", 515, 284)
	mywindow:setTexture("Pushed", "UIData/LobbyImage_new002.tga", 515, 284)
	mywindow:setTexture("PushedOff", "UIData/invisible.tga", 515, 284)
	...
	mywindow:setTexture("SelectedPushed", "UIData/LobbyImage_new002.tga", 515, 284)
	mywindow:setTexture("SelectedPushedOff", "UIData/invisible.tga", 515, 284)
	mywindow:setPosition(tMatchPosX[4], tMatchPosY[4])
	mywindow:setSize(27, 27)
	mywindow:setAlwaysOnTop(true)
	mywindow:setZOrderingEnabled(false)
	mywindow:setProperty("Selected", "false")
	mywindow:subscribeEvent("CheckStateChanged", tMatchEvent[4])
	quickmatchBackwindow:addChildWindow(mywindow)
end
...
if CheckfacilityData(FACILITYCODE_MINITOWERBATTLE) == 1 then
	...
	mywindow = winMgr:createWindow("TaharezLook/Checkbox", tMatchName[5])
	mywindow:setTexture("Normal", "UIData/invisible.tga", 515, 284)
	mywindow:setTexture("Hover", "UIData/invisible.tga", 515, 284)
	mywindow:setTexture("Pushed", "UIData/LobbyImage_new002.tga", 515, 284)
	mywindow:setTexture("PushedOff", "UIData/invisible.tga", 515, 284)
	...
	mywindow:setTexture("SelectedPushed", "UIData/LobbyImage_new002.tga", 515, 284)
	mywindow:setTexture("SelectedPushedOff", "UIData/invisible.tga", 515, 284)
	mywindow:setPosition(tMatchPosX[5], tMatchPosY[5])
	mywindow:setSize(27, 27)
	mywindow:setAlwaysOnTop(true)
	mywindow:setZOrderingEnabled(false)
	mywindow:setProperty("Selected", "false")
	mywindow:subscribeEvent("CheckStateChanged", tMatchEvent[5])
	quickmatchBackwindow:addChildWindow(mywindow)
end
...
function MiniTowerMatchCheck(args)
	if CEGUI.toCheckbox(CEGUI.toWindowEventArgs(args).window):isSelected() then
		MATCH_MINITOWERMATCH = SELECTED
	else
		MATCH_MINITOWERMATCH = NOT_CHECK
	end
end
...
function QuickMatchAdjust_OK()
	...
	WndLobby_FileSaveFixMatch( MATCH_DEATHMATCH, MATCH_MONSTERRACING, MATCH_DUALMATCH,
								MATCH_COINMATCH, MATCH_BOMBMATCH, MATCH_MINITOWERMATCH ,
...
function ClickFitMatchButton()
	WndLobby_JustGo_Adjust( MATCH_DEATHMATCH, MATCH_MONSTERRACING, MATCH_DUALMATCH,
							...
							MODE_PRIVATE, MODE_TEAM,
							TYPE_NOITEM, TYPE_ITEM, TYPE_CLASS,
							MATCH_BOMBMATCH, MATCH_MINITOWERMATCH )
end
...
function SetFitMatchInfo( _MATCH_DEATHMATCH, _MATCH_MONSTERRACING, _MATCH_DUALMATCH,
	...
	if MATCH_MINITOWERMATCH == 1 then
		...
		if WindowData ~= nil then
			winMgr:getWindow("Lobby_CheckBox_MiniTowerMatch"):setProperty("Selected", "true")			
		end
	else
		local WindowData = winMgr:getWindow("Lobby_CheckBox_MiniTowerMatch")
